      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div>
          ...
          <p className="mt-6 text-gray-400 max-w-xl">
            I have 1+ years of experience working on client-based applications using 
            Java, Spring Boot, React.js, and MySQL. I specialize in building REST APIs, 
            integrating frontend and backend systems, and developing real-world solutions.
          </p>
